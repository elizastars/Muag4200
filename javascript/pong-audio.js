...
export var wallSound = new soundFile("loud thunder.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("rattling.mp3");
...
export var adventureMusic = new soundFile("thunder.mp3");
